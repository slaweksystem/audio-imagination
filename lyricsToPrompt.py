...
class PromptFromLyrics:
    ...
    def defineStartInFrames(self):
        return self.secondsToFrames(self.lyrics[0]['start'], self.fps)

    def defineEndInFrames(self):
        return self.secondsToFrames(self.lyrics[-1]['end'], self.fps)
...
if __name__ == "__main__":
    #rint(PromptFromLyrics().defineStartInFrames())
    print(PromptFromLyrics().makePrompt())